...
@interface HJTDatePickerView ()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate> {
    //日期存储数组
...
@implementation HJTDatePickerView
...
-(void)setDatePickerStyle:(HJTDateStyle)datePickerStyle {
